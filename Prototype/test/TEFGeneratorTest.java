...
public class TEFGeneratorTest {

	@Test
	public void TEFGenerator() {
		// set up
		...
		TEFGenerator tefG = new TEFGenerator();
		HashMap<Pro, Double> amounts = tefG.getAmounts();



		Assert.assertEquals(amounts.get(pro), 100.0, 0.0);
	}
